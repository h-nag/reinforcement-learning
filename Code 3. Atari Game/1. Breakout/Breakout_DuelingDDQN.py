...
from keras.layers import Dense, Lambda, Flatten, Input, merge
...
class DuelingDDQNAgent:
    ...
    def build_model(self):
        ...
        hidden1 = Conv2D(32, (8, 8), strides=(4, 4), activation='relu', input_shape=self.state_size)(input)
        hidden2 = Conv2D(64, (4, 4), strides=(2, 2), activation='relu')(hidden1)
        hidden3 = Conv2D(64, (3, 3), strides=(1, 1), activation='relu')(hidden2)
        fully1 = Flatten()(hidden3)
        fully2 = Dense(512, activation='relu')(fully1)

        state_value = Dense(1, activation='relu')(fully2)
        state_value = Lambda(lambda s: k.expand_dims(s[:, 0], -1), output_shape=(self.action_size,))(state_value)

        action_advantage = Dense(self.action_size, activation='relu')(fully2)
    ...
    def train_replay(self):
        ...
        for i in range(batch_size):
            ...
            if done:
                ...
                a = np.argmax(self.model.predict(next_history)[0])
                target[action] = reward + self.discount_factor * (self.target_model.predict(history)[0][a])
...
if __name__ == "__main__":
    ...
    agent = DuelingDDQNAgent(action_size)
    ...
    for e in range(EPISODES):
        ...
        while not done:
            ...
            if done:
                ...
                pylab.savefig("./save_graph/Breakout_DuelingDDQN.png")
                print("episode:", e, "  score:", score, "  memory length:", len(agent.memory),
                      "  epsilon:", agent.epsilon, "  global_step:", global_step)

        if e % 1000 == 0:
            agent.save_model("./save_model/Breakout_DuelingDDQN.h5")